...
## About
Molecular protein sequences are only as useful, for evolutionary inferences, as the degree of signatures they retain. When very little time has passed since evolution from the most recent common ancestor, the information accrued in the sequences will most likely be insufficient for any valuable inference to be deducible. When the evolution time is too long, the sequences are said to have saturated. That is, the evolutionary signatures are most probably eroded for such sequences to yield reliable inferences. Functions designed to assist with quantifying the extent of saturation of sequences that share a common ancestor are presented. Compared to existing tools for similar purpose, the primary functions herein add at least three new features to the literature. First, they are developed upon Bayesian principles. Second, they allow for site-wise assessment of saturation such that they are useful for more than just phylogeny reconstruction inquests. For example, they are amenable to heterogeneous natural selection pressure analyses. Third, they permit for investigations in terms of DNA, codon and amino acid bases.
