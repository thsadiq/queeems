...
- [varNS](varNS): contains the resources for the changing natural selection effect analyses.
 - [gdata15](varNS/gdata15.txt): five replicates of the (100 codon sites)-by-(64 leaves) genetic sequences simulated with the variance of the non-synonymous selection coefficients set equal to 0.15.
 - [gdata30](varNS/gdata30.txt): five replicates of the (100 codon sites)-by-(64 leaves) genetic sequences simulated with the variance of the non-synonymous selection coefficients set equal to 0.30.
 - [gdata45](varNS/gdata45.txt): five replicates of the (100 codon sites)-by-(64 leaves) genetic sequences simulated with the variance of the non-synonymous selection coefficients set equal to 0.45.
 - [gdata60](varNS/gdata60.txt): five replicates of the (100 codon sites)-by-(64 leaves) genetic sequences simulated with the variance of the non-synonymous selection coefficients set equal to 0.60.
 - [gdata75](varNS/gdata75.txt): five replicates of the (100 codon sites)-by-(64 leaves) genetic sequences simulated with the variance of the non-synonymous selection coefficients set equal to 0.75.
